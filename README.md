...
Для построения обучающего набора данных были выбраны последние 41 день работы каждого диска. Из-за этого в набор не вошли 19 дисков. Для дисков, вышедших из строя, во всех строках признак `failure` назначался равным 1.
...
Исходя из рассмотрения таблицы 2, в качестве лучшей модели выбран градиентный бустинг с использованием ADASYN и признаков: `smart_5_raw`, `smart_9_raw`, `smart_187_raw`, `smart_188_raw` `smart_192_raw`, `smart_197_raw`, `smart_198_raw`, `smart_199_raw`,
